document.addEventListener("DOMContentLoaded", (event) => {
  ...
  document.querySelectorAll(".cell").forEach((button) => {
    button.addEventListener("click", function () {
      ...
      //play your turn
      token = "";
      if (buttonId == 1) token = game.playRound(0, 0);
      else if (buttonId == 2) token = game.playRound(0, 1);
      else if (buttonId == 3) token = game.playRound(0, 2);
      else if (buttonId == 4) token = game.playRound(1, 0);
      else if (buttonId == 5) token = game.playRound(1, 1);
      else if (buttonId == 6) token = game.playRound(1, 2);
      else if (buttonId == 7) token = game.playRound(2, 0);
      else if (buttonId == 8) token = game.playRound(2, 1);
      else if (buttonId == 9) token = game.playRound(2, 2);

      // Update the button's innerHTML with the token
...
//restart game, and reset isWon to false --done
//clear the board, clear the virual bored --done
//change name
